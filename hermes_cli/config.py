...
DEFAULT_CONFIG = {
    ...
    "auxiliary": {
        ...
        "title_generation": {
            "enabled": True,
            "mode": "",  # empty/"llm" = call auxiliary LLM; "extract" = derive from user message without an LLM call
            "provider": "auto",
            "model": "",
            "base_url": "",
            "api_key": "",
    ...
    "dashboard": {
        "theme": "default",  # Dashboard visual theme: "default", "default-large", "nous-blue", "midnight", "ember", "mono", "cyberpunk", "rose", "aurora"
