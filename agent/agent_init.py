...
def init_agent(
    ...
    # Per-session metadata that intentionally rides on the current user message
    # instead of the cached system prompt to preserve KV-cache prefix reuse.
    agent._session_metadata_line: str = ""
