...
The dashboard ships with eight built-in theme options and can be extended with user-defined themes, plugin tabs, and backend API routes — all drop-in, no repo clone needed.
...
| **Aurora** (`aurora`) | Glassmorphic black with purple, pink, and cyan glow |
