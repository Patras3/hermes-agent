...
LAZY_DEPS: dict[str, tuple[str, ...]] = {
    ...
    "platform.teams": ("microsoft-teams-apps==2.0.13.4", "pydantic-settings==2.14.2", "aiohttp==3.14.1"),  # aiohttp 3.14.1: CVE-2026-34993(RCE)/47265 + 34513/34518/34519/34520/34525

    # ─── Terminal backends ─────────────────────────────────────────────────
    "terminal.modal": ("modal==1.3.4", "cbor2==5.9.0", "click==8.3.3"),
